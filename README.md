...
* `language/` for the syntax of LambdaFit and the "oblivious" semantics of the
  language.
* `final/` for the "main" semantics of LambdaFit and associated results.
* `program_logic/` for program logic.
* `sequential/` for the emulation of the sequential mode presented
in [A High-Level Separation Logic for Heap Space under Garbage Collection](https://dl.acm.org/doi/10.1145/3571218).
...
* Figure 10: in folder `program_logic/`
...
* Figure 14: in folder `program_logic/`
...
* Figure 15: in folder `program_logic/`
...
* Figure 17: in folder `program_logic/`
...
* Figure 18: in folder `program_logic/`
...
* Figure 30: file `program_logic/wp_spec.v`
